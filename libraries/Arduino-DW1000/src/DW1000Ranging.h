...
public:
    ...
    static void    startAsAnchor(char address[], const byte mode[], uint8_t shortAddress, const bool randomShortAddress = false);
	static void    startAsTag(char address[], const byte mode[], uint8_t shortAddress, const bool randomShortAddress = false);
